...
class PruningMethod:
    def __init__(self, model, pruning_rate, image_shape, pruning_criterion, exact_pruning):
        self.model = model
        device = None
...
class Liu2017(PruningMethod):
    def __init__(self, model, pruning_criterion, pruning_rate, penalty, image_shape, exact_pruning):
        super(Liu2017, self).__init__(model, pruning_rate, image_shape, pruning_criterion, exact_pruning)
